...
#undef TRACE_LOG
#endif
#define TRACE_LOG(args...) Athena::WriteLog(getpid(), __FILE__, __LINE__, Athena::LV_TRACE, args)

#ifdef DEBUG_LOG
#undef DEBUG_LOG
#endif
#define DEBUG_LOG(args...) Athena::WriteLog(getpid(), __FILE__, __LINE__, Athena::LV_DEBUG, args)

#ifdef ERROR_LOG
#undef ERROR_LOG
#endif
#define ERROR_LOG(args...) Athena::WriteLog(getpid(), __FILE__, __LINE__, Athena::LV_ERROR, args)

#define FILE_LOG(args...) Athena::WriteLog3(args)

#define ERROR_LOG_REF(fmt,args...) ERROR_LOG("refer [%s], "fmt, m_Params["refer"].c_str(), args)

#define DEBUG_LOG2(args...) Athena::WriteLog2( __FILE__, __LINE__, LV_DEBUG, args)

#define WRITE_BIN Athena::WriteHex
